...
// #region MAP-ADDCONTROL(mapbox-gl-DRAW)
...
function autoGenerateLine(poly) {
    ...
    for (let index = 0; index < 5; index++) {
        if (smoother.features.length>0) {
            ...
            console.log('generate lines: no feats in geojson file')
    }
    }
...
// #endregion
// #region USER-DRAWn-POLY-*** updateArea()-*** -BLUE
function updateArea(e) {
    ...
    if (polygon.features.length > 0) {
        ...
        answer.innerHTML = `${roundedLength} mt | ${roundedArea} sq-meters`;
...
// #region HANDL3RS id's in Chkboxes map[handl3r] 
const handlers = [
    "scrollZoom",
    "boxZoom",
    "dragRotate",
...
// #endregion
// #region Custom layer for 3D model: CustomLayerInterface
